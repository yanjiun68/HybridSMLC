...
static const _MissionSnapshot_type_support_symbol_names_t _MissionSnapshot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_lc_interfaces, msg, MissionSnapshot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim_lc_interfaces, msg, MissionSnapshot)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlesim_lc_interfaces, msg, MissionSnapshot)() {
  return &::turtlesim_lc_interfaces::msg::rosidl_typesupport_c::MissionSnapshot_message_type_support_handle;
}

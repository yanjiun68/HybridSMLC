...
bool turtlesim_lc_interfaces__msg__mission_snapshot__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtlesim_lc_interfaces.msg._mission_snapshot.MissionSnapshot", full_classname_dest, 61) == 0);
  }
  turtlesim_lc_interfaces__msg__MissionSnapshot * ros_message = _ros_message;
  {  // header
  ...
  {  // trajectory_vector
    PyObject * field = PyObject_GetAttrString(_pymsg, "trajectory_vector");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__vector3__convert_from_py(field, &ros_message->trajectory_vector)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // completed_laps
    PyObject * field = PyObject_GetAttrString(_pymsg, "completed_laps");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->completed_laps = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // current_side
    PyObject * field = PyObject_GetAttrString(_pymsg, "current_side");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->current_side = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // phase
...
{
  /* NOTE(esteve): Call constructor of MissionSnapshot */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtlesim_lc_interfaces.msg._mission_snapshot");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MissionSnapshot");
  ...
  {  // trajectory_vector
    PyObject * field = NULL;
    field = geometry_msgs__msg__vector3__convert_to_py(&ros_message->trajectory_vector);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "trajectory_vector", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // completed_laps
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->completed_laps);
    {
      int rc = PyObject_SetAttrString(_pymessage, "completed_laps", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // current_side
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->current_side);
    {
      int rc = PyObject_SetAttrString(_pymessage, "current_side", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
